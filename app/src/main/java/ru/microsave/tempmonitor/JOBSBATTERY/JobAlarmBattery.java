...
class JobAlarmBattery extends AsyncTask <JobParameters, Void, JobParameters> implements SensorEventListener {
    ...
    public JobAlarmBattery(JobService jobService, String num, int war, Boolean al, Boolean sen, float tempBat) {
