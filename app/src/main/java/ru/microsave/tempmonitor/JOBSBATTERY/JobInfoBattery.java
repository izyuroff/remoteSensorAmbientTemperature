...
class JobInfoBattery extends AsyncTask <JobParameters, Void, JobParameters> implements SensorEventListener {
    ...
    public JobInfoBattery(JobService jobService, String num, int war, Boolean al, Boolean sen, float tempBat) {
