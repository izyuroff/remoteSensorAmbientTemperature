...
class JobInfo extends AsyncTask <JobParameters, Void, JobParameters> implements SensorEventListener {
    ...
    public JobInfo(JobService jobService, String num, int war, Boolean al, Boolean sen, float tempBat) {
