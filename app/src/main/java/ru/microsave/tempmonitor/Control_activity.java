...
public class Control_activity extends AppCompatActivity {
    ...
    public void jobPlan() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            //mPeriodic = 1000L * 60 * 65; // Решено посмотреть на разных устройствах качество срабатывания
            //mFlexPeriodic = 1000L * 60 * 5; // Решено посмотреть на разных устройствах качество срабатывания
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            mPeriodicAlarm = multiAlarm * 1000L * 60 * 65; // Решено посмотреть на разных устройствах качество срабатывания
            mFlexPeriodicAlarm = multiAlarm * 1000L * 60 * 5; // Решено посмотреть на разных устройствах качество срабатывания
